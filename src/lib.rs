...
pub trait CommandHandler<W, Coord, B, const N: usize, const WORLDS: usize>
where
...
pub async fn start<'d, Coord, B, W, H, P, const WORLDS: usize, const S: usize, const N: usize>(
    buffer: &mut B,
    ...
    B: Buffer<Coord, N>,
    W: Tick<Coord, B, N> + GetTicker + GetWorld + OnDirection,
    H: CommandHandler<W, Coord, B, N, WORLDS>,
    P: Instance,
{
